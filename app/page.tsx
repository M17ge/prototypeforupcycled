...
export default function Home() {
  ...
  return (
    <>
      {/* ── INTRO LOADER ─────────────────────────────────────────────────── */}
      {!loaded && <IntroLoader onComplete={handleLoaderComplete} />}

      <main
        className="bg-zinc-950 text-zinc-100 antialiased"
        style={{ visibility: loaded ? "visible" : "hidden" }}
      >
        {/* Hero with animated split logo */}
        <HeroSection />

        {/* On The Rack — product grid */}
        <section
          className="relative border-t border-zinc-800/80 bg-zinc-950 px-6 py-24 md:px-12"
          id="on-the-rack"
        >
        ...
        {/* Off The Grid — process editorial */}
        <section
          className="relative overflow-hidden border-t border-zinc-800/80 bg-zinc-900 px-6 py-28 md:px-12"
          id="off-the-grid"
        >
